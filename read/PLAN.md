...
### 7. Поле "Год" заполнено значением 23
### Шаги
- Ввести валидный номер карты
- Ввести валидное значение поля "Месяц"
...
### 8. Поле "Год" заполнено значением 00
### Шаги
- Ввести валидный номер карты
- Ввести валидное значение поля "Месяц"
...
### 17. Проведение операции при вводе рандомного номера карты, состоящей из 16 цифр.
### Шаги
